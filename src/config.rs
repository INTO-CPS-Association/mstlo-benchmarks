...
pub struct Args {
    ...
    #[arg(long, default_value_t = 12.0, value_parser = positive_f32)]
    pub arena_width: f32,

    #[arg(long, default_value_t = 12.0, value_parser = positive_f32)]
    pub arena_height: f32,

    #[arg(long, default_value_t = 0.4, value_parser = non_negative_f32)]
    pub brownian_scale: f32,

    #[arg(long, default_value_t = 60.0, value_parser = positive_f32)]
    pub sim_hz: f32,

    #[arg(long, default_value_t = 10.0, value_parser = positive_f32)]
    ...
    #[arg(long, default_value_t = 2.0, value_parser = non_negative_f32)]
